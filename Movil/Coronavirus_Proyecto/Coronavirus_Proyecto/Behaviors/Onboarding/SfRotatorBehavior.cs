...
using Coronavirus_Proyecto.ViewModels.Onboarding;
...
namespace Coronavirus_Proyecto.Behaviors.Onboarding
{
    /// <summary>
    ...
    public class SfRotatorBehavior : Behavior<SfRotator>
    {
        ...
        public void Animation(SfRotator rotator, double selectedIndex)
        {
            if (rotator != null && rotator.ItemsSource != null && rotator.ItemsSource.Count() > 0)
            {
                ...
                if (selectedIndex == itemsCount - 1)
                {
                    ...
                    viewModel.IsSiguienteButtonVisible = true;
                ...
                else
                {
                    ...
                    viewModel.IsSiguienteButtonVisible = false;
                }
        ...
        public async void StartAnimation(List<Xamarin.Forms.View> childElement, Boarding item)
        {
