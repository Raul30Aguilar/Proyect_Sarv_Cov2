...
namespace Coronavirus_Proyecto.Controls
{
    ...
    public class CountryComboBox : SfComboBox, INotifyPropertyChanged
    {
        ...
        private string phoneNumberPlaceHolder = "Ingrese Numero";
        ...
        public CountryComboBox()
        {
            ...
            {
                Country = "Arequipa",
                States = new string[] { "Cayma", "Yanahuara", "Mariano Melgar", "Cerro Colorado" }
            });
            Countries.Add(new CountryModel()
            {
                Country = "Lima",
                States = new string[] { "Comas", "Miraflores", "La Victoria", "Carabayllo" }
            });
