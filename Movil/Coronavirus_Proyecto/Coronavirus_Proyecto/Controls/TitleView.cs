...
namespace Coronavirus_Proyecto.Controls
{
    /// <summary>
    /// The Title view
    /// </summary>
    ...
    public class TitleView : Grid
    {
        ...
        /// </summary>
        public static readonly BindableProperty LeadingViewProperty = BindableProperty.Create(nameof(LeadingView), typeof(Xamarin.Forms.View), typeof(TitleView), new ContentView(), BindingMode.Default, null, OnLeadingViewPropertyChanged);

        /// <summary>
        /// Gets or sets the TrailingViewProperty, and it is a bindable property.
        /// </summary>
        public static readonly BindableProperty TrailingViewProperty = BindableProperty.Create(nameof(TrailingView), typeof(Xamarin.Forms.View), typeof(TitleView), new ContentView(), BindingMode.Default, null, OnTrailingViewPropertyChanged);

        /// <summary>
        /// Gets or sets the ContentProperty, and it is a bindable property.
        /// </summary>
        public static readonly BindableProperty ContentProperty = BindableProperty.Create(nameof(Content), typeof(Xamarin.Forms.View), typeof(TitleView), new ContentView(), BindingMode.Default, null, OnContentPropertyChanged);
        ...
        /// </summary>
        public Xamarin.Forms.View LeadingView
        {
            get { return (Xamarin.Forms.View)GetValue(LeadingViewProperty); }
        ...
        /// </summary>
        public Xamarin.Forms.View TrailingView
        {
            get { return (Xamarin.Forms.View)GetValue(TrailingViewProperty); }
        ...
        private static void OnLeadingViewPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            var newView = (Xamarin.Forms.View)newValue;
