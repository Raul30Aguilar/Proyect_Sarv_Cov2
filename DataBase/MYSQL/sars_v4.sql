...
--
-- Host: localhost    Database: sars_cov_2
-- ------------------------------------------------------
...
CREATE TABLE `ciudadano` (
  ...
  `nomciudadano` varchar(45) NOT NULL,
  `apeciudadano` varchar(45) NOT NULL,
  `celciudadano` char(9) NOT NULL,
  `edadciudadano` int NOT NULL,
  `docciudadano` int NOT NULL,
  `dirciudadano` varchar(100) NOT NULL,
  `iddepartamento` int NOT NULL,
  `idprov` int NOT NULL,
  `iddistrito` int NOT NULL,
  `idtipodocumento` int NOT NULL,
  `fecha` datetime NOT NULL,
  PRIMARY KEY (`docciudadano`),
  KEY `ix_tmp_autoinc` (`idciudadano`),
  KEY `fk_iddepartamento` (`iddepartamento`),
  KEY `fk_iddistri` (`iddistrito`),
  KEY `fk_idprovi` (`idprov`),
  ...
  CONSTRAINT `fk_iddistri` FOREIGN KEY (`iddistrito`) REFERENCES `distrito` (`iddistrito`),
  CONSTRAINT `fk_idprovi` FOREIGN KEY (`idprov`) REFERENCES `provincia` (`idprov`),
  CONSTRAINT `fk_idtipodocumento` FOREIGN KEY (`idtipodocumento`) REFERENCES `tipo_documento` (`idtipodocumento`)
...
INSERT INTO `ciudadano` VALUES (2,'Alejandro','Quiñonez','963852741',20,5144596,'Las Vegas 3005',15,15,15,1,'2020-06-03 01:44:12'),(1,'Raul','Aguilar','936062682',20,75987420,'Las Manzanas 123',15,15,15,1,'2020-06-03 01:42:51');
...
CREATE TABLE `departamento` (
  ...
  `descripdepa` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`iddepartamento`),
  KEY `ix_tmp_autoinc` (`iddepartamento`)
...
CREATE TABLE `distrito` (
  ...
  KEY `ix_tmp_autoinc` (`iddistrito`),
  KEY `fk_idprov` (`idprov`),
  CONSTRAINT `fk_idprov` FOREIGN KEY (`idprov`) REFERENCES `provincia` (`idprov`)
...
--
-- Table structure for table `estado_ciudadano`
--

DROP TABLE IF EXISTS `estado_ciudadano`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `estado_ciudadano` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idestado` int DEFAULT NULL,
  `docciudadano` int DEFAULT NULL,
  `idtriaje` int DEFAULT NULL,
  `fechaRegistro` datetime DEFAULT NULL,
  `fechaModificacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_tmp_autoinc` (`id`),
  KEY `fk__estadi_ci_idestado` (`idestado`),
  KEY `fk__estado_ci__idtri__7b5b524b_idx` (`idtriaje`),
  KEY `fk__estado_ci_docciu_idx` (`docciudadano`),
  CONSTRAINT `fk__estadi_ci_idestado` FOREIGN KEY (`idestado`) REFERENCES `tipo_estado` (`idestado`),
  CONSTRAINT `fk__estado_ci_docciu` FOREIGN KEY (`docciudadano`) REFERENCES `ciudadano` (`docciudadano`),
  CONSTRAINT `fk__estado_ci_idtriaje` FOREIGN KEY (`idtriaje`) REFERENCES `triaje` (`idtriaje`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `estado_ciudadano`
--

LOCK TABLES `estado_ciudadano` WRITE;
/*!40000 ALTER TABLE `estado_ciudadano` DISABLE KEYS */;
INSERT INTO `estado_ciudadano` VALUES (1,2,75987420,1,'2020-06-03 01:42:51','2020-06-03 01:42:51'),(2,2,5144596,2,'2020-06-03 01:44:12','2020-06-03 01:44:12');
/*!40000 ALTER TABLE `estado_ciudadano` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `operacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_tmp_autoinc` (`id`),
  KEY `fk__operacion__idmod__45f365d3` (`idmodulo`),
  CONSTRAINT `fk__operacion__idmod__45f365d3` FOREIGN KEY (`idmodulo`) REFERENCES `modulo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `provincia` (
  ...
  PRIMARY KEY (`idprov`),
  KEY `fk_iddepa` (`iddepa`),
  CONSTRAINT `fk_iddepa` FOREIGN KEY (`iddepa`) REFERENCES `departamento` (`iddepartamento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rol_operacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_tmp_autoinc` (`id`),
  KEY `fk__rol_opera__idope__47dbae45` (`idoperacion`),
  KEY `fk__rol_opera__idrol__48cfd27e` (`idrol`),
  CONSTRAINT `fk__rol_opera__idope__47dbae45` FOREIGN KEY (`idoperacion`) REFERENCES `operacion` (`id`),
  CONSTRAINT `fk__rol_opera__idrol__48cfd27e` FOREIGN KEY (`idrol`) REFERENCES `rol` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rol_operacion`
--

LOCK TABLES `rol_operacion` WRITE;
/*!40000 ALTER TABLE `rol_operacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `rol_operacion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tipo_documento` (
  ...
  `destipodocumento` varchar(50) NOT NULL,
  PRIMARY KEY (`idtipodocumento`),
  KEY `ix_tmp_autoinc` (`idtipodocumento`)
...
INSERT INTO `tipo_documento` VALUES (1,'DNI'),(2,'RUC'),(3,'CARNET EXTRANJERIA'),(4,'PASAPORTE');
...
INSERT INTO `tipo_estado` VALUES (1,'Posible Infectado'),(2,'Descartado');
...
CREATE TABLE `triaje` (
  ...
  `question1` bit(1) NOT NULL,
  `question2` bit(1) NOT NULL,
  `question3` bit(1) NOT NULL,
  `question4` bit(1) NOT NULL,
  `question5` bit(1) NOT NULL,
  `question_obesidad` bit(1) NOT NULL,
  `question_enfermedad` bit(1) NOT NULL,
  `question_diabetes` bit(1) NOT NULL,
  `question_hipertension` bit(1) NOT NULL,
  `question_cancer` bit(1) NOT NULL,
  `question2_adulto` bit(1) NOT NULL,
  `question2_nino` bit(1) NOT NULL,
  `question2_gestante` bit(1) NOT NULL,
  `question2_cronica` bit(1) NOT NULL,
  `persona` int NOT NULL,
  `fecha` date NOT NULL,
  `docciudadano` int NOT NULL,
  PRIMARY KEY (`idtriaje`),
  KEY `ix_tmp_autoinc` (`idtriaje`),
  KEY `fk_triaje_docciu_idx` (`docciudadano`),
  CONSTRAINT `fk_triaje_docciu` FOREIGN KEY (`docciudadano`) REFERENCES `ciudadano` (`docciudadano`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `triaje` VALUES (1,_binary '',_binary '\0',_binary '\0',_binary '',_binary '',_binary '',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '',3,'2020-06-03',75987420),(2,_binary '',_binary '\0',_binary '\0',_binary '',_binary '',_binary '',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '',3,'2020-06-03',5144596);
...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_tmp_autoinc` (`id`),
  KEY `fk__usuario__idrol__4ab81af0` (`idrol`),
  CONSTRAINT `fk__usuario__idrol__4ab81af0` FOREIGN KEY (`idrol`) REFERENCES `rol` (`id`)
...
INSERT INTO `usuario` VALUES (1,'Raul','raul30fac@gmail.com','123456','2020-05-31',1);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `add_status_ciu` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_status_ciu`(in idstatus int,in doc int,in triaje int)
BEGIN
insert into estado_ciudadano (idestado,docciudadano,idtriaje,fechaRegistro,fechaModificacion) 
values (idstatus,doc,triaje,sysdate(),sysdate());
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `put_status_ciu` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `put_status_ciu`(in idstatus int, in doc int)
BEGIN
update estado_ciudadano set idestado=idstatus,fechaModificacion=sysdate() 
where docciudadano=doc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_add_cuixtriaje` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_cuixtriaje`(in nom varchar(45),in ape varchar(45),
in cel char(9),in edad int,in doc int,in dir varchar(100),
in depa int,in prov int,in dis int,in tdoc int,
in qua1 bit, in qua2 bit,in qua3 bit, in qua4 bit,in qua5 bit,in qua_obe bit,in qua_enfe bit,in qua_dia bit,
in qua_hipe bit,in qua_can bit,in qua_adu bit, in qua_ni bit, in qua_ges bit,in qua_cro bit,in per int
)
BEGIN
insert into ciudadano (`nomciudadano`,`apeciudadano`,`celciudadano`,
	`edadciudadano`,`docciudadano`,
    `dirciudadano`,`iddepartamento`,`idprov`,`iddistrito`,
    `idtipodocumento`,`fecha`) values (nom,ape,cel,edad,doc,dir,depa,prov,dis,tdoc,sysdate());
insert into triaje (`question1`,`question2`,`question3`,`question4`,`question5`,`question_obesidad`,
`question_enfermedad`,`question_diabetes`,
`question_hipertension`,`question_cancer`,`question2_adulto`,`question2_nino`,
`question2_gestante`,`question2_cronica`,
`persona`,`fecha`,`docciudadano`) values (qua1,qua2,qua3,qua4,qua5,qua_obe,qua_enfe,qua_dia,qua_hipe,qua_can,qua_adu,
qua_ni,qua_ges,qua_cro,per,sysdate(),doc);
CALL `sars_cov_2`.`sp_count_triaje`();
CALL `sars_cov_2`.`add_status_ciu`(@cot,doc,@id);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_count_triaje` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_count_triaje`()
BEGIN
SELECT MAX(idtriaje) into @id FROM triaje;
select @id;
SELECT @valor:=question1+question2+question3+question4+question5+question_obesidad+
question_enfermedad+question_diabetes+
question_hipertension+question_cancer+question2_adulto+question2_nino+
question2_gestante+question2_cronica as conteo,@cot:=if(@valor>7,1,2) FROM triaje t 
where idtriaje= @id;
select @cot;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_ciu_and_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_ciu_and_status`()
BEGIN
SELECT c.nomciudadano,
c.apeciudadano,c.edadciudadano,c.fecha,c.docciudadano,
t.estado FROM sars_cov_2.ciudadano c join estado_ciudadano e 
on c.docciudadano=e.docciudadano join tipo_estado t on e.idestado=t.idestado;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_depa` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_depa`()
BEGIN
SELECT departamento.descripdepa FROM departamento;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_distrito` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_distrito`()
BEGIN
select distrito.distrito from distrito;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_prov` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_prov`()
BEGIN
select provincia.provincia from provincia;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_triajeXdoc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_triajeXdoc`(in doc int)
BEGIN
SELECT IF(question1=1,'Si','No') as question1,
IF(question2=1,'Si','No') as question2,IF(question3=1,'Si','No') as question3,
IF(question4=1,'Si','No') as question4,IF(question5=1,'Si','No') as question5,
IF(question_obesidad=1,'Si','No') as Obesidad,IF(question_enfermedad=1,'Si','No') as Enfermedad,
IF(question_diabetes=1,'Si','No') as Diabetes,IF(question_hipertension=1,'Si','No') as question_hipertension,
IF(question_cancer=1,'Si','No') as Cancer,IF(question2_adulto=1,'Si','No') as Adulto,
IF(question2_nino=1,'Si','No') as Nino,IF(question2_gestante=1,'Si','No') as Gestante,
IF(question2_cronica=1,'Si','No') as Cronica,persona,c.docciudadano
 FROM sars_cov_2.triaje t join ciudadano c on t.docciudadano=c.docciudadano
 where c.docciudadano=doc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_list_ubigeo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_list_ubigeo`(in depa varchar(50),in prov varchar(50),in distri varchar(50))
BEGIN
select d.descripdepa as 'DEPARTAMENTO',
	   p.provincia as 'PROVINCIA',dis.distrito as 'DISTRITO' from departamento d join
       provincia p on d.iddepartamento=p.iddepa join
       distrito dis on p.idprov=dis.idprov
      WHERE d.descripdepa= depa and p.provincia=prov and dis.distrito=distri;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2020-06-03  1:49:46
